...
export class Base1647093821568 implements MigrationInterface {
    name = 'Base1647093821568'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "listing" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "phone" character varying, "message" character varying, "valid" character varying NOT NULL DEFAULT false, "fileId" uuid, CONSTRAINT "PK_381d45ebb8692362c156d6b87d7" PRIMARY KEY ("id"))`);
